...
### Input
InputThe first line contains a single integer t (1≤t≤104) — the number of test cases.The first and only line of each test case contains two integers n and k (2≤n≤109; 1≤k≤109) — the number of spots and hour k.

### Output
OutputFor each test case, print one integer — the index of the spot where cat B will sleep at hour k.
