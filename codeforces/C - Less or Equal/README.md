...
### Input
InputThe first line of the input contains integer numbers n and k (1≤n≤2⋅105, 0≤k≤n). The second line of the input contains n integer numbers a1,a2,…,an (1≤ai≤109) — the sequence itself.

### Output
OutputPrint any integer number x from range [1;109] such that exactly k elements of given sequence is less or equal to x.If there is no such x, print "-1" (without quotes).
