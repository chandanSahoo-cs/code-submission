...
### Input
InputThe first line contains a single integer t (1≤t≤104) — the number of test cases. The description of the test cases follows.Each test case consists of a single line containing one integer n (1≤n≤2⋅105) — the length of the desired permutation.The sum of n over all test cases does not exceed 2⋅105.

### Output
OutputFor each test case, output in a separate line:  n integers — a super-permutation of length n, if it exists.  −1, otherwise. If there are several suitable permutations, output any of them.
