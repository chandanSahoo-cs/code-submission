# [C. Simple Strings](https://codeforces.com/contest/665/problem/C)
...
### Output
OutputPrint the simple string s' — the string s after the minimal number of changes. If there are multiple solutions, you may output any of them.Note that the string s' should also consist of only lowercase English letters.
