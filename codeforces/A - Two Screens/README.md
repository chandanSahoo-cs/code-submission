# [A. Two Screens](https://codeforces.com/contest/2025/problem/A)
...
### Input
InputThe first line contains one integer q (1≤q≤500) — the number of test cases.Each test case consists of two lines. The first line contains the string s, and the second line contains the string t (1≤|s|,|t|≤100). Both strings consist of uppercase Latin letters.

### Output
OutputFor each test case, print one integer — the minimum possible number of seconds you have to spend so that the first screen displays the sequence s, and the second screen displays the sequence t.
