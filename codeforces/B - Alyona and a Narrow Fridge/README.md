# [B. Alyona and a Narrow Fridge](https://codeforces.com/contest/1119/problem/B)
...
### Input
InputThe first line contains two integers n and h (1≤n≤103, 1≤h≤109) — the number of bottles and the height of the fridge.The second line contains n integers a1, a2, ..., an (1≤ai≤h) — the heights of the bottles.

### Output
OutputPrint the single integer k — the maximum integer such that Alyona can put the bottles 1, 2, ..., k in the fridge at the same time. If Alyona can put all bottles in the fridge, print n. It is easy to see that Alyona can always put at least one bottle in the fridge.
NoteOne of optimal locations in the first example is shown on the picture in the statement.One of optimal locations in the second example is shown on the picture below.  One of optimal locations in the third example is shown on the picture below.
