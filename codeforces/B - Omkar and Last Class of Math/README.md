# [B. Omkar and Last Class of Math](https://codeforces.com/contest/1372/problem/B)
...
### Input
InputEach test contains multiple test cases. The first line contains the number of test cases t (1≤t≤10). Description of the test cases follows.Each test case consists of a single integer n (2≤n≤109).

### Output
OutputFor each test case, output two positive integers a and b, such that a+b=n and LCM(a,b) is the minimum possible.
