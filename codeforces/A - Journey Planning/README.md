# [A. Journey Planning](https://codeforces.com/contest/1320/problem/A)
...
### Input
InputThe first line contains one integer n (1≤n≤2⋅105) — the number of cities in Berland.The second line contains n integers b1, b2, ..., bn (1≤bi≤4⋅105), where bi is the beauty value of the i-th city.

### Output
OutputPrint one integer — the maximum beauty of a journey Tanya can choose.
