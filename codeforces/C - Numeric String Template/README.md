...
### Output
OutputFor each test case, output m lines. On the i-th line (1≤i≤m) output:   "YES", if the string with index i matches the template;  "NO" otherwise. You may output the answer in any case (for example, the strings "yEs", "yes", "Yes", and "YES" will be recognized as a positive answer).
