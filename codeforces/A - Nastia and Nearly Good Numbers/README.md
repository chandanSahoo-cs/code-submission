# [A. Nastia and Nearly Good Numbers](https://codeforces.com/contest/1521/problem/A)
...
### Input
InputThe first line contains a single integer t (1≤t≤10000) — the number of test cases.The first line of each test case contains two integers A and B (1≤A≤106, 1≤B≤106) — numbers that Nastia has.

### Output
OutputFor each test case print:   "YES" and 3 different positive integers x, y, and z (1≤x,y,z≤1018) such that exactly one of them is good and the other 2 are nearly good, and x+y=z.  "NO" if no answer exists.  You can print each character of "YES" or "NO" in any case.If there are multiple answers, print any.
