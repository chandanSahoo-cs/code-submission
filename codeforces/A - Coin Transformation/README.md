# [A. Coin Transformation](https://codeforces.com/contest/2043/problem/A)

---
Initially, you have a coin with value n. You can perform the following operation any number of times (possibly zero):  transform one coin with value x, where x is greater than 3 (x>3), into two coins with value ⌊x4⌋. What is the maximum number of coins you can have after performing this operation any number of times?

### Input
InputThe first line contains one integer t (1≤t≤104) — the number of test cases.Each test case consists of one line containing one integer n (1≤n≤1018).
