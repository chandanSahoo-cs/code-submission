...
### Input
InputThe first line contains one integer t (1≤t≤500) — the number of test cases.Each test case consists of two lines:   the first line contains one integer n (1≤n≤100);  the second line contains the string s, consisting of n characters. Each character of s is either < or >.

### Output
OutputFor each test case, print one integer — the minimum cost among all arrays which are compatible with the given string s.
NoteIn the first test case of the example, the array can be [13,37,42,37,13].In the second test case of the example, the array can be [42,37,13,37,42].
