...
### Input
InputThe first line contains one integer t (1≤t≤100) — the number of test cases.The first line of each test case contains one integer n (1≤n≤100) — the length of array a.The second line of each test case contains n integers a1,a2,…,an (1≤ai≤100).

### Output
OutputFor each test case print the shuffled version of the array a which is good.
